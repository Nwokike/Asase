...
class AtmosphericService:
    ...
    async def fetch_location_telemetry(lat: float, lon: float) -> dict:
        """Fetch comprehensive atmospheric, AQI, flood risk, and weather telemetry for coordinates."""
        telemetry = {
            "weather": {},
            "air_quality": {},
            "flood": {},
        ...
        async with httpx.AsyncClient(timeout=12.0) as client:
            ...
            weather_url = (
                ...
                "&hourly=temperature_2m,precipitation_probability,wind_gusts_10m,cape&forecast_days=3"
            )
            try:
            ...
            aqi_url = (
                ...
                "&hourly=european_aqi,us_aqi,pm2_5,pm10&forecast_days=3"
            )
            try:
